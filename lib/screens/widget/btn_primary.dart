...
class PrimaryButton extends StatelessWidget {
  ...
  const PrimaryButton({
    ...
    this.textColor = MyColors.colorBlack,
    this.isLeading = false,
    this.enabled = true,
    this.borderColor = MyColors.colorBlack,
    this.leadingChild,
    this.trailingChild,
    this.borderRadius,
    this.topPadding,
    ...
    this.addSpaceBetweenLeadingAndText,
    this.showNearToText,
    this.isLeadingPng,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: RawMaterialButton(
        fillColor: enabled ? backgroundColor : backgroundColor.withOpacity(0.5),
        elevation: 0.0,
        focusElevation: 0.0,
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                title,
                style: titleStyle ?? Styles.textStyle.copyWith(color: MyColors.colorWhite),
              ),
